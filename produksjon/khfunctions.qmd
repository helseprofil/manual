...
-   Når en kjøring inkluderer STATA-kode vil det lagres midlertidige filer som brukes av STATA. Dette gjelder for de fleste kuber pga STATA-prikking. De midlertidige filene lagres lokalt på din PC, i `helseprofil`-mappen, og overskrives forløpende.

-   Dersom noe har gått galt i STATA, kan du finne `.log`-filen her.
